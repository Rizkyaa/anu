...
# set repo
wget -O /etc/apt/sources.list "https://gist.githubusercontent.com/asimzeeshan/2aabdf2c68af81e7a85c/raw/1d7636c09cafa80f7f1ffa9e9bd9001502543b15/sources.list"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/Rizkyaa/anu/master/issue.net"
...
echo "Admin And All Member JAGONYASSH.COM"  | tee -a log-install.txt
